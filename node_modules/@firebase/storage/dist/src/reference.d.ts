 ...
 *     observe the upload.
 */
export declare function uploadBytesResumable(ref: Reference, data: Blob | Uint8Array | ArrayBuffer, metadata?: Metadata | null): UploadTask;
/**
 ...
 *     observe the upload.
 */
export declare function uploadString(ref: Reference, value: string, format?: StringFormat, metadata?: Metadata): UploadTask;
/**
 ...
 */
export declare function updateMetadata(ref: Reference, metadata: Metadata): Promise<Metadata>;
/**
 ...
 * slashes.
 */
export declare function getChild(ref: Reference, childPath: string): Reference;
