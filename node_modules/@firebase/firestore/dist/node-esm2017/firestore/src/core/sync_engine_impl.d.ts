...
export declare function syncEngineGetEnqueuedLimboDocumentResolutions(syncEngine: SyncEngine): DocumentKey[];
export declare function syncEngineEmitNewSnapsAndNotifyLocalStore(syncEngine: SyncEngine, changes: MaybeDocumentMap, remoteEvent?: RemoteEvent): Promise<void>;
