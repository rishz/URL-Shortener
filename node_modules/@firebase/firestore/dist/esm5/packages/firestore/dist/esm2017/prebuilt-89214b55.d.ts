...
declare class Yr {
    ...
    Uu(): void;
    cancel(): void;
    /** Returns a random value in the range [-currentBaseMs/2, currentBaseMs/2] */ qu(): number;
}
/**
 * @license
 * Copyright 2017 Google LLC
...
declare class Ss {
     ...
     */ static Is(t: any, e: any, n: any, s: any, i: any): Ss;
     ...
     * createAndSchedule().
     */ start(t: any): void;
    As: NodeJS.Timeout | null | undefined;
    /**
 ...
 */ declare class tt {
    static ft(t: any): tt;
    static dt(t: any): tt;
    static J(t: any, e: any): 0 | 1 | -1;
    static Et(t: any): boolean;
    /**
    ...
    constructor(t: any);
    path: any;
    /** Returns true if the document is in the specified collectionId. */ wt(t: any): boolean;
    isEqual(t: any): boolean;
    toString(): any;
}
/**
...
declare namespace q {
    const UNAUTHENTICATED: q;
    const P: q;
    const g: q;
}
export { Gu as G, Ku as K, Uu as U, Wu as W, Xu as X, Yu as Y, Zu as Z, nh as a, Xa as b, Za as c, ch as d, eh as e, ah as f, ih as i, ju as j, na as n, qu as q, rh as r };
