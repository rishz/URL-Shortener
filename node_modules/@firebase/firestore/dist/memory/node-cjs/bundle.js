...
class LoadBundleTask {
    constructor() {
        ...
        this._taskCompletionResolver = new databaseD6566d8f.Deferred();
        this._lastProgress = {
            taskState: 'Running',
            totalBytes: 0,
            totalDocuments: 0,
...
function loadBundle(db, bundleData) {
    ...
    databaseD6566d8f.firestoreClientLoadBundle(databaseD6566d8f.ensureFirestoreConfigured(db._delegate), db._databaseId, bundleData, resultTask);
    return resultTask;
}
function namedQuery(db, name) {
    return databaseD6566d8f.firestoreClientGetNamedQuery(databaseD6566d8f.ensureFirestoreConfigured(db._delegate), name).then(namedQuery => {
        if (!namedQuery) {
            return null;
        }
        return new databaseD6566d8f.Query$1(db, new databaseD6566d8f.Query(db._delegate, null, namedQuery.query));
    });
}
...
registerBundle(databaseD6566d8f.Firestore);
